...
let catalogMenuButton = document.querySelector('.catalog-menu__button');
let catalogMenuBody = document.querySelector('.catalog-menu__body');
let catalogMenu = document.querySelector('.catalog-menu');
let menuRow = document.querySelector('.menu__row')
let menuBody = document.querySelector('.menu__body');
let submenuList = document.querySelector('.submenu-list');
catalogMenuButton.addEventListener("click", function (e) {
		catalogMenu.classList.toggle("_active");
		menuRow.classList.toggle("_active");
		submenuList.classList.toggle("_active");

});
if (isMobile.any()) {
	let menuParents = document.querySelectorAll('.submenu-list__item');
	for (let index = 0; index < menuParents.length; index++) {
		const menuParent = menuParents[index];
		menuParent.addEventListener("click", function (e) {
			let subMenuBody = menuParent.lastElementChild;
			if (!menuParent.classList.contains('_active')) {
				subMenuBody.classList.add('_active');
				menuParent.classList.add('_active');
			}else{
				subMenuBody.classList.remove('_active');
	...
	for (let index = 0; index < menuParents.length; index++) {
		...
		menuParent.addEventListener("mouseenter", function (e) {
			menuParent.classList.add('_active');
			submenuList.classList.add('_active');
		});
		menuParent.addEventListener("mouseleave", function (e) {
			menuParent.classList.remove('_active');
			submenuList.classList.remove('_active');
		});
	}
...
let bigSlider = document.querySelector('.big-slider__body');
if (bigSlider) {
	new Swiper('.big-slider__body', {
		/*
		effect: 'fade',
		autoplay: {
			delay: 3000,
		...
		*/
		...
		// Dotts
		pagination: {
			el: '.controls-big-slider__dotts',
			clickable: true,
		},
		// Arrows
		navigation: {
			nextEl: '.controls-big-slider__arrow_next',
			prevEl: '.controls-big-slider__arrow_prev',
		},
		/*
		breakpoints: {
			320: {
...
let popularSlider = document.querySelector('.popular__slider');
if (popularSlider) {
	new Swiper( popularSlider , {
		...
		*/
		...
		// Arrows
		navigation: {
			nextEl: '.controls-popular__arrow_next',
			prevEl: '.controls-popular__arrow_prev',
		},
